...
- Automatic 6-character device pairing code flow using `/api/v1/device/pairing/start` and `/api/v1/device/pairing/status`
- No manual API URL or device-token entry
...
6. The TV shows a pairing code automatically; enter that code in the PlayOnMyTV dashboard.
